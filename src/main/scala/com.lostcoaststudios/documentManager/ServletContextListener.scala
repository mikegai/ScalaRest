  ...
  def getInjector:Injector = {
    val i= Guice.createInjector(
      ...
      new ScalateModule() {
        ...
        //serveWith("*.foo", classOf[TestServlet])

        // back ticks because with is a keyword in scala
        ...
        override def resourcePackageNames = "com.lostcoaststudios.documentManager.resources" :: super.resourcePackageNames
        override def createResourceConfigProperties:Map[String,AnyRef] =
          super.createResourceConfigProperties ++ Map(JSONConfiguration.FEATURE_POJO_MAPPING -> "true")
